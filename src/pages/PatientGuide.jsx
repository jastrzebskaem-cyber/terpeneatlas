      ...
      },
      {
        ...
        steps: [
          ...
          },
          {
            ...
            examples: [
              "Cytrusowy → prawdopodobnie wysoka zawartość limonenu → działanie pobudzające, przeciwlękowe",
              "Ziemisty, piżmowy → prawdopodobnie wysoka zawartość mircenu → działanie relaksujące, sedatywne",
              "Korzenny, pieprzny → prawdopodobnie wysoka zawartość kariofilenu → działanie przeciwzapalne",
              "Sosnowy → prawdopodobnie wysoka zawartość pinenu → działanie poprawiające koncentrację",
              "Kwiatowy, lawendowy → prawdopodobnie wysoka zawartość linalolu → działanie uspokajające, przeciwlękowe",
            ],
          },
        ],
      },
