// FIX #14: Removed empty comment placeholder blocks from hero section
...
export default function TerpenesEncyclopedia() {
  usePageTitle("Przewodnik po Terpenach", "Encyklopedia terpenów konopnych — Mircen, Limonen, Kariofilen i inne. Zapachy, właściwości i odmiany dostępne w Polsce.");
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      ...
      <div className="text-center mb-10">
        ...
        <p className="text-muted-foreground text-base sm:text-lg max-w-2xl mx-auto">
          Terpeny to naturalne związki aromatyczne, wytwarzane przez konopie i wiele innych roślin. Kliknij na terpen, aby dowiedzieć się więcej o jego właściwościach i w jakich odmianach występuje.
        </p>
      </div>
...
function TerpeneCard({ terpene }) {
  return (
    ...
    >
      ...
      <p className="text-xs text-muted-foreground mb-3 line-clamp-2">{terpene.scent}</p>
