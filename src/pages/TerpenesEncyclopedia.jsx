...
export default function TerpenesEncyclopedia() {
  useSEO({
    title: "Encyklopedia terpenów w medycznej marihuanie",
    description: "Poznaj terpeny w suszu konopnym — mircen, limonen, linalol, kariofilen i inne. Jak profil terpenowy konopi wpływa na działanie marihuany medycznej? Sprawdź encyklopedię.",
    canonical: "https://www.terpeneatlas.org/terpeny"
  });
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      ...
      <div className="text-center mb-10">
        ...
        <h1 className="font-playfair text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground mb-3">
          Encyklopedia terpenów w medycznej marihuanie
        </h1>
        <p className="text-muted-foreground text-base sm:text-lg max-w-2xl mx-auto">
          Terpeny to naturalne związki aromatyczne w suszu konopnym, które współtworzą profil terpenowy odmiany i wpływają na jej działanie terapeutyczne. Poznaj najważniejsze terpeny w konopiach medycznych.
        </p>
      </div>
