...
export default function Home() {
  ...
  useSEO({
    title: "Odmiany medycznej marihuany – susz konopny w Polsce",
    description: "Porównuj odmiany suszu konopnego dostępne w polskich aptekach. Filtruj po profilu terpenowym, THC i genetyce. Znajdź zamiennik marihuany medycznej gdy zioło jest niedostępne.",
    canonical: "https://www.terpeneatlas.org/"
  });
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      ...
      <div className="text-center mb-10">
        ...
        <h1 className="font-playfair text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground mb-3">
          Porównaj odmiany medycznej marihuany
        </h1>
        <p className="text-muted-foreground text-base sm:text-lg max-w-2xl mx-auto mt-3">
          Baza suszu konopnego dostępnego w Polsce — filtruj po profilu terpenowym, genetyce i dostępności. Znajdź zamiennik swojego leku gdy zioło jest niedostępne w aptece.
        </p>
      </div>
...
function FilterSelect({ label, value, onChange, options }) {
  return (
    <div>
      ...
      {/* SEO text block */}
      <div className="mt-16 pt-10 border-t border-border text-sm text-muted-foreground space-y-3 max-w-3xl mx-auto">
        <h2 className="font-playfair text-lg font-semibold text-foreground">Czym jest TerpeneAtlas?</h2>
        <p>
          TerpeneAtlas to bezpłatna baza wiedzy o odmianach medycznej marihuany dostępnych w Polsce. 
          Każdy susz konopny zawiera unikalny profil terpenowy, który wpływa na jego działanie terapeutyczne — 
          niezależnie od zawartości THC czy CBD.
        </p>
        <p>
          Jeśli Twoje zioło konopne jest chwilowo niedostępne w aptece, porównywarka TerpeneAtlas 
          pomoże Ci znaleźć zamiennik o podobnym profilu terpenowym — tak żeby efekt terapeutyczny 
          był jak najbardziej zbliżony.
        </p>
        <p>
          Sprawdź też <a href="/terpeny" className="text-primary hover:underline">encyklopedię terpenów</a> i{" "}
          <a href="/poradnik-pacjenta" className="text-primary hover:underline">poradnik pacjenta</a> — 
          dowiedz się jak czytać profile terpenowe i świadomie dobierać konopie medyczne.
        </p>
      </div>
