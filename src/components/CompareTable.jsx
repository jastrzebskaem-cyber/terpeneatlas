                            ...
                            <div className="flex items-center gap-2">
                              <div className="flex-1 h-1.5 bg-muted rounded-full overflow-hidden min-w-[60px]">
                                <div
                                  ...
                                  style={{ width: `${(val / 10) * 100}%`, opacity: val === maxVal ? 1 : 0.45 }}
                                />
                              </div>
                              <span className={`text-xs w-4 text-right ${val === maxVal && maxVal > 0 ? "text-primary font-semibold" : "text-muted-foreground"}`}>
                                {val}
                              </span>
                            </div>
                          ) : (
